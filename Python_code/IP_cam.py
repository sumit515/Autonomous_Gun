...
url = "http://192.168.43.13:8080/shot.jpg"
...
ser.port = 'COM17'        #change it for your owm com port
ser.open()
pre_servo_lower=0
pre_servo_upper=0
pre_servo_lower1=0
...
pre_center_y=0
start_time=0
kernel = np.ones((7,7),np.uint8)    #filter_array
...
def calibrateColor(color, def_range):   # this function sets the color of the object that you want to detect
    ...
    while (1):
        ...
        frameinv= cv2.imdecode(img_arr, -1)
        frameinv = imutils.resize(frameinv, width=1000, height=1800)
